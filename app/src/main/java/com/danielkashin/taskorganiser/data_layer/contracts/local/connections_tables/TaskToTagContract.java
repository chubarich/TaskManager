...
public class TaskToTagContract implements IdContract {
  ...
  public static final String COLUMN_NAME_UNIQUE_TASK_ID = "task_global_id";

  public static final String COLUMN_NAME_TAG_ID = "tag_id";

  public static final String SQL_CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "("
      + COLUMN_NAME_ID + " INTEGER NOT NULL PRIMARY KEY, "
      + COLUMN_NAME_UNIQUE_TASK_ID + " INTEGER NOT NULL, "
      + COLUMN_NAME_TAG_ID + " INTEGER NOT NULL, "
      + "UNIQUE(" + COLUMN_NAME_UNIQUE_TASK_ID + ", " + COLUMN_NAME_TAG_ID + ") ON CONFLICT REPLACE"
      + ");";
