...
import com.danielkashin.taskorganiser.presentation_layer.presenter.no_date_tasks.INoDateTasksPresenter;
...
import com.danielkashin.taskorganiser.presentation_layer.presenter.no_date_tasks.NoDateTasksPresenter;
...
public class NoDateTasksFragment extends PresenterFragment<NoDateTasksPresenter, INoDateTasksView>
    implements INoDateTasksView, ITaskGroupAdapter.Callbacks {
  ...
  public void onStart() {
    ...
    ((INoDateTasksPresenter) getPresenter()).onGetTaskGroupData();
  }
  ...
  public static NoDateTasksFragment getInstance() {
    return new NoDateTasksFragment();
  }
  ...
  public void onCreateTask(String name, String UUID, ITaskGroup taskGroup) {
    ...
    ((INoDateTasksPresenter) getPresenter()).onSaveTask(task);
  }
  ...
  @Override
  public void initializeAdapter(DateTypeTaskGroup taskGroup) {
    if (mRecyclerView.getAdapter() == null) {
  ...
  @Override
  protected INoDateTasksView getViewInterface() {
    return this;
  }

  @Override
  protected IPresenterFactory<NoDateTasksPresenter, INoDateTasksView> getPresenterFactory() {
    ...
    GetNoDateTaskGroupUseCase getTaskGroupUseCase = new GetNoDateTaskGroupUseCase(
        tasksRepository,
    ...
    return new NoDateTasksPresenter.Factory(getTaskGroupUseCase, saveTaskUseCase);
  }
